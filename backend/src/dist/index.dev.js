                    ...
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 14:
                            _context.next = 16;
                            return pool.query("DROP TRIGGER IF EXISTS set_users_updated_at    ON public.users;");

                          case 16:
                            _context.next = 18;
                            return pool.query("DROP TRIGGER IF EXISTS set_messages_updated_at ON public.messages;");
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , promises_1['default'].readFile(tmpPath)];

        case 2:
          buf = _a.sent();
          hash = sha256(buf);
          fileName = 'user_' + username + '_' + hash + '.webp';
          finalPath = path_1['default'].join(uploadPath, fileName); // console.log("FINAL PATH: ", finalPath);

          return [4
          /*yield*/
          , sharp_1['default'](buf).resize(512).webp({
            quality: 95
          }).toFile(finalPath)];
...
app.patch('/user', upload.single('avatar'), function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          _a = req.body, content = _a.content, username = _a.username; // Validacija chto takoj polzovatel est. 73-135 stroki dlja app.post(`/user` kak primer
